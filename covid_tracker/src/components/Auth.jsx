...
const Auth = () => {
  ...
  /*  const handleSubmit = async (e) => { //accept event
        ...
        const { data: { 
            token, userId, hashedPassword, fullName } } = await axios.post(`${URL}/${isSignup ? 'signup' : 'login'}`, {
            username, password, fullName: form.fullName, phoneNumber, avatarURL,
        });
        //get data from backend and store in cookies
        ...
        const handleSubmit = async (e) => {
            ...
            const { username, password, phoneNumber, avatarURL } = form;
            const URL = 'http://localhost:5000/auth'; // Make sure it's http not https
